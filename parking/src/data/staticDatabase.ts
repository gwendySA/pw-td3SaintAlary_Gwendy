...
export const parkings: Parking[] = [
    ...
    new Parking("E",cities[3].id, {latitude:28.487180709838867,longitude:-16.313879013061523
    },70,3.10),
    new Parking("F",cities[4].id, {latitude:54.9738474,longitude:-1.6131572
    },60,2.40),
    new Parking("G",cities[4].id, {latitude:54.9738474,longitude:-1.6131572
    },90,3.20),
